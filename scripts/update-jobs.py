#!/usr/bin/env python3
"""
or-pay-hub/scripts/update-jobs.py
Daily job data updater — Oregon Pay Hub edition.
"""
...
CATEGORY_MAP = {
    ...
    "sales": "Sales", "operations": "Operations", "hr": "People & HR",
    "people": "People & HR", "recruiting": "People & HR",
    "legal": "Legal", "compliance": "Legal", "security": "Security",
    "manager": "Management", "director": "Management", "vp": "Management",
}
...
def main():
        ...
        with open(raw_file) as f:
            for line in f:
                ...
                try:
                    ...
                    continue
                if not (25000 <= val_min < val_max <= 1_500_000):
                    continue
                job.setdefault("currency", "USD")
                job.setdefault("region", "OR")
    ...
    db["meta"] = {
        ...
        "updated": TIMESTAMP,
        "state": "Oregon",
        "law": "Oregon Equal Pay Act (ORS § 652.220)",
        "currency": "USD",
        "region": "OR",
    }
